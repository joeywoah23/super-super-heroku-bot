...
return message.reply("You can\'t unpunish yourself!");
      ...
      const unmuteembedo = new RichEmbed()
      ...
      client.channels.get(`${process.env.LOGS_CHANNEL}`).send(unmuteembedo)
	    const unmutesendembed = new RichEmbed()
	    .setTitle(`${process.env.OS_NAME} | Unmute`)
